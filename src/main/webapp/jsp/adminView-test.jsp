...
<body>
    ...
    <div class="tab-content">
        ...
        <div id="option4" class="container tab-pane fade"><br>
            ...
            <br>
            <div class="container">
                <form:form action="#", method="post", modelAtrribute='company'>
                    <div class="row">
                        <div class="col-25">
                            <label for="companyname">Company Code</label>
                        </div>
                        <div class="col-75">
                            <form:input path="companyname" type="text" id="companyname" name="companyname" placeholder="Company Code"/>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-25">
                        ...
                        <div class="col-75">
                            <form:input path="stockExcgangeName" type="text" id="stockExchangeName" name="stockExchangeName"
                    ...
                    <div class="row">
                        ...
                        <div class="col-75">
                            <form:input path="price" type="numeber" id="pps" name="pps" placeholder="Price"/>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-25">
                        ...
                        <div class="col-75">
                            <form:input path="totalShare" type="number" id="totalshare" name="totalshare" placeholder="Total Number of Share"/>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-25">
                        ...
                        <div class="col-75">
                            <form:input path="opendate" type="date" id="opendate" name="opendate" placeholder="Open Date"/>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-25">
                        ...
                        <div class="col-75">
                            <form:input path="remarks" textarea id="remarks" name="remarks" placeholder="Remarks" style="height:200px"/>
                        </div>
                    </div>
                    <div class="row">
